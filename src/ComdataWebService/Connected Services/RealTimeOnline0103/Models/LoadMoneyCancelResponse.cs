...
namespace Comdata.RealTimeOnline0103.Models
{
    ...
    public partial class LoadMoneyCancelResponseBody : ISoapResponseBody<LoadMoneyCancelResponse>
    {
        public LoadMoneyCancelResponseBody() : this(new LoadMoneyCancelResponse()) { }
        public LoadMoneyCancelResponseBody(LoadMoneyCancelResponse response) { Response = response; }



        [System.ServiceModel.MessageBodyMemberAttribute(Namespace = "http://cows0103.comdata.com", Order = 0)]
        [System.Xml.Serialization.XmlElementAttribute(ElementName = "loadMoneyCancelReturn", Form = System.Xml.Schema.XmlSchemaForm.Unqualified, IsNullable = true)]
