...
<<<<<<< HEAD
    ...
    public partial class DriverIdRecord
    {
        /// <summary>
        ...
        /// <summary>
        /// 2-letter state abbreviation (US) or province abbreviation (Canada)
        /// </summary>
        ...
        /// </summary>
        [XmlElement(ElementName = "misc1", Form = XmlSchemaForm.Unqualified, IsNullable = true, Order = 7)]
        public string? Misc1 { get; set; }

        /// <summary>
        /// Value assigned to the Misc2 field
        /// </summary>
        [XmlElement(ElementName = "misc2", Form = XmlSchemaForm.Unqualified, IsNullable = true, Order = 8)]
        public string? Misc2 { get; set; }

        /// <summary>
        /// Value assigned to the Driver Email address field
        /// </summary>
        [XmlElement(ElementName = "driverEmail", Form = XmlSchemaForm.Unqualified, IsNullable = true, Order = 9)]
        public string? DriverEmail { get; set; }

        /// <summary>
        /// Value Y or N or Blank.
        /// </summary>
        [XmlElement(ElementName = "onHoldFlag", Form = XmlSchemaForm.Unqualified, IsNullable = true, Order = 10)]
        public string? OnHoldFlag { get; set; }

        /// <summary>
        /// Date the cardIdentifier hold will be released (YYYY-MM-DD)
        /// </summary>
        [XmlElement(ElementName = "holdReleaseDate", Form = XmlSchemaForm.Unqualified, IsNullable = true, Order = 11)]
        public string? HoldReleaseDate { get; set; }

        /// <summary>
        /// Time the cardIdentifier hold will be released (HHMM) 24-hour format
        /// </summary>
        [XmlElement(ElementName = "holdReleaseTime", Form = XmlSchemaForm.Unqualified, IsNullable = true, Order = 12)]
=======
    ...
    public partial class DriverIdRecord
    {
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(ElementName = "misc1", Form = System.Xml.Schema.XmlSchemaForm.Unqualified, IsNullable = true, Order = 7)]
        public string? Misc1 { get; set; }

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(ElementName = "misc2", Form = System.Xml.Schema.XmlSchemaForm.Unqualified, IsNullable = true, Order = 8)]
        public string? Misc2 { get; set; }

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(ElementName = "driverEmail", Form = System.Xml.Schema.XmlSchemaForm.Unqualified, IsNullable = true, Order = 9)]
        public string? DriverEmail { get; set; }

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(ElementName = "onHoldFlag", Form = System.Xml.Schema.XmlSchemaForm.Unqualified, IsNullable = true, Order = 10)]
        public string? OnHoldFlag { get; set; }

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(ElementName = "holdReleaseDate", Form = System.Xml.Schema.XmlSchemaForm.Unqualified, IsNullable = true, Order = 11)]
        public string? HoldReleaseDate { get; set; }

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(ElementName = "holdReleaseTime", Form = System.Xml.Schema.XmlSchemaForm.Unqualified, IsNullable = true, Order = 12)]
>>>>>>> releases/v1.0.0
