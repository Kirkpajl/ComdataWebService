...
<<<<<<< HEAD
    ...
    public partial class MailingDetailsV02
    {
        /// <summary>
        /// 1 UPS Next Day Air 
        /// 2 [NOT USED]
        ...
        /// <remarks/>
        [XmlElement(ElementName = "mailCountry", Form = XmlSchemaForm.Unqualified, IsNullable = true, Order = 8)]
=======
    ...
    public partial class MailingDetailsV02
    {
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(ElementName = "mailCountry", Form = System.Xml.Schema.XmlSchemaForm.Unqualified, IsNullable = true, Order = 8)]
>>>>>>> releases/v1.0.0
