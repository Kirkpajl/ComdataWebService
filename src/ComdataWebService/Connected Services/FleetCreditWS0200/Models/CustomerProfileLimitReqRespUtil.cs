...
=======
    ...
    public partial class CustomerProfileLimitReqRespUtil
    {
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(ElementName = "profileID", Form = System.Xml.Schema.XmlSchemaForm.Unqualified, IsNullable = true, Order = 4)]
        public string? ProfileID { get; set; }

        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute(ElementName = "productCode", Form = System.Xml.Schema.XmlSchemaForm.Unqualified, IsNullable = true, Order = 5)]
