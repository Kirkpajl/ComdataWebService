...
namespace Comdata.FleetCreditWS0200.Models
{
    ...
    [System.ServiceModel.MessageContractAttribute(WrapperName = "IntradayResponse", WrapperNamespace = "http://fleetCredit02.comdata.com/maintenance/", IsWrapped = true)]
    public partial class IntradayV01Response
    {
        ...
        public IDTransactionRecordV01[]? Records;
...
>>>>>>> releases/v1.0.0
        ...
        public IntradayV01Response(System.Nullable<int> pageCount, System.Nullable<int> pageNbr, System.Nullable<int> recordCount, IDTransactionRecordV01[] records, string responseCode, string responseDescription)
        {
