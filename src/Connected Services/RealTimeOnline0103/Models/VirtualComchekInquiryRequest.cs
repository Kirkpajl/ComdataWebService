...
namespace Comdata.RealTimeOnline0103.Models
{
    ...
    public partial class VirtualComchekInquiryRequestBody : IRequest<VirtualComchekInquiryRequest>
    {
        public VirtualComchekInquiryRequestBody() : this(new VirtualComchekInquiryRequest()) { }
        public VirtualComchekInquiryRequestBody(VirtualComchekInquiryRequest request) { Content = request; }



        [MessageBodyMember(Namespace = "http://cows0103.comdata.com", Order = 0)]
        [XmlElement(ElementName = "inquiryRequest", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
        public VirtualComchekInquiryRequest Content { get; set; }
    }
    ...
    public partial class VirtualComchekInquiryRequest : IRequest
    {
        /// <remarks/>
