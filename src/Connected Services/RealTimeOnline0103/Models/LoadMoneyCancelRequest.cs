...
namespace Comdata.RealTimeOnline0103.Models
{
    ...
    public partial class LoadMoneyCancelRequestBody : IRequest<LoadMoneyCancelRequest>
    {
        public LoadMoneyCancelRequestBody() : this(new LoadMoneyCancelRequest()) { }
        public LoadMoneyCancelRequestBody(LoadMoneyCancelRequest request) { Content = request; }



        [MessageBodyMember(Namespace = "http://cows0103.comdata.com", Order = 0)]
        [XmlElement(ElementName = "cancelRequest", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
        public LoadMoneyCancelRequest Content { get; set; }
    }
    ...
    public partial class LoadMoneyCancelRequest : IRequest
    {
        /// <summary>
