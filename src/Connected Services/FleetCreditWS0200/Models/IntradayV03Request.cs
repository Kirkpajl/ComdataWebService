...
namespace Comdata.FleetCreditWS0200.Models
{
    ...
    public partial class IntradayV03Request : IRequest
    {
        ...
        public IntradayV03Request(DateTime? start, IntradayDetailType detailType = IntradayDetailType.Regular, YesNoCharFlag maskCardFlag = YesNoCharFlag.No, int maxRows = 10000, int pageNumber = 1)
            : this(start?.ToString("yyyy-MM-dd"), start?.ToString("HH:mm:ss"), detailType, maskCardFlag, maxRows, pageNumber) { }

        public IntradayV03Request(string? startDate, string? startTime, IntradayDetailType detailType, YesNoCharFlag maskCardFlag, int maxRows = 10000, int pageNumber = 1)
        {
