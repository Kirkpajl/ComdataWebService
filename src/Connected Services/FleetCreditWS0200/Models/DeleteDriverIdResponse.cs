...
namespace Comdata.FleetCreditWS0200.Models
{
    ...
    [MessageContract(WrapperName = "DriverIdDeleteResponse", WrapperNamespace = "http://fleetCredit02.comdata.com/maintenance/", IsWrapped = true)]
    public partial class DeleteDriverIdResponse : IResponse
    {
        /// <summary>
