...
namespace Comdata.FleetCreditWS0200.Models
{
    ...
    public partial class RealTimeTransactionHistoryV03Response : IResponse
    {
        ...
        public RtTransactionRecordV03[] Records { get; set; } = Array.Empty<RtTransactionRecordV03>();
        ...
        public RealTimeTransactionHistoryV03Response(int pageCount, int pageNumber, int recordCount, RtTransactionRecordV03[] records, int responseCode, string responseDescription)
        {
